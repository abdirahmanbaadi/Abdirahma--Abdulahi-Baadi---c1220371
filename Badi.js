...
const deleteManyResult = await studen.deleteMany({ name: "Samar"});
console.log("Deleted Many:", deleteManyResult.deletedCount);


const deleteOneResult = await studen.deleteOne({ name: "jihaan"});
